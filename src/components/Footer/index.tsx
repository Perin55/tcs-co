          ...
          <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-4/12 xl:w-3/12">
            <div className="mb-10 w-full">
              ...
              <p className="mb-8 max-w-[270px] text-base text-gray-7">
                We Started our professional consultancy firm in the year 2019. 
                We bleieve in the quelity of the work while maintaining the respect 
                of the profession of chartered accoutants.
              </p>
